                ...
                <div className='main'>
                    <form className='modal' method='POST' action='/registration'>
                        ...
                        <div className='templates'>
                            <div>
                                <input placeholder='Enter Your Name' type='text' onChange={handleFirstChange}
                                       name='name' required='required'></input>
                            </div>
                            <div>
                                <input placeholder='Enter Your Surname' type='text' onChange={handleLastChange}
                                       name='surname' required='required'></input>
                            </div>
                            <div>
                                <input placeholder='Enter Your Email' type='text' onChange={handleEmailChange}
                                       name='email' required='required'></input>
                                <div>{isValidated ? '' :
                                    <div className='firstError'>Please Validate your email </div>} </div>
                            </div>
                            <div>
                                <input placeholder='Enter Your Password' onChange={handlePasswordChange} name='password'
                                       type='password' required='required'></input>
                            </div>
                            <div>
                                <input placeholder='Repeat Your Password' onChange={handleRepeatPassword}
                                       name='repPassword' type='password' required='required'></input>
                                <div>{isCorrectPassword ? '' :
                                    <div className='firstError'>Passwords don't match</div>} </div>
                            </div>
                        </div>
